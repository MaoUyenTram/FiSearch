...
class AnnotationController extends Controller
{
    ...
    {
        //return var_dump(base64_encode(file_get_contents($request->file('image'))) == base64_encode(file_get_contents(public_path('pdf/').substr("test.pdf",0,-4).'.jpg')));
        if ($request->file('image')) {
            ...
            $request->setImage(base64_encode(file_get_contents(public_path('pdf/').substr("test.pdf",0,-4).'.jpg')));
